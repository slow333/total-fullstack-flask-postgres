...
import innerJoin from '../../../assets/inner-join.png';
import leftJoin from '../../../assets/left-join.png';
import rightJoin from '../../../assets/right-join.png';
import fullOuterJoin from '../../../assets/full-outer-join.png';

function PsqlJoin() {
  return (
    <div>
      <div id='psql-join' className="for-space"></div>
      <h1>JOIN</h1>
      ...
      <table>
        <tr>
          <td> <img src={innerJoin} alt='inner join' /></td>
          <td> <img src={leftJoin} alt='left join' /></td>
        </tr>
        <tr>
          <td><img src={rightJoin} alt="right join" /></td>
          <td><img src={fullOuterJoin} alt="full outer join" /></td>
        </tr>
      </table>
      {/* <!-- ############## inner join #########################--> */}
